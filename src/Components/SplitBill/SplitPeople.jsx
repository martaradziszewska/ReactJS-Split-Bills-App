		...
		return(
			<div className = "splitBox">
				...
				<div className="paidBySelect">
					<p>Paid by:</p>
					{this.state.selectedRadio === "equally" && <select className="paidySelection" value={this.state.paidBy} onChange={e=>this.handlePaidBy(e)}>{this.props.checkedGroup.people.map((name, indx)=><option key={indx} value={name}>{name}</option>)}</select>}
				</div>
